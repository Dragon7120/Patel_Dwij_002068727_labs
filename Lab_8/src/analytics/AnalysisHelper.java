...
public class AnalysisHelper 
{
    ...
    // To find the post with maximum likes for the comment
    ...
    // To find the post with maximum comments
    ...
    // To find top 5 inactive users based on number of their posts
    ...
    // To find top 5 inactive users based on total comments they created
    ...
    // To find top 5 inactive and top 5 proactive users overall (sum of comments+posts+likes)
